...
public class NotificationService extends Service {
    ...
    public static final String SERVICE_NAME = "com.example.ribbit.myapplication.client.NotificationService";
    ...
    public static Intent getIntent() {
        return new Intent(SERVICE_NAME).setAction("com.example.ribbit.myapplication.client.NotificationService");
